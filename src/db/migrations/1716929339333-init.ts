...
export class Init1716929339333 implements MigrationInterface {
  name = 'Init1716929339333';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "space" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "user_id" uuid NOT NULL, "type" "public"."space_type_enum" NOT NULL DEFAULT 'free', "totalMemory" integer NOT NULL DEFAULT '2024', "usedMemory" double precision NOT NULL DEFAULT '0', "maxFileSizeUpload" integer NOT NULL DEFAULT '100', CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "files" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "filename" text NOT NULL, "originalName" text NOT NULL, "mimetype" text NOT NULL, "size" double precision NOT NULL, "data" bytea NOT NULL, "space_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
